...
export const FAQ_MAIN = {
    ...
    items: [
        ...
        },
        {
            ...
            a: "Kluczowe są rzuty architektoniczne lub dokładne wymiary pomieszczeń. Dodatkowo prosimy o tzw. moodboard (inspiracje materiałowe, kolory, tekstury). Jeśli projekt jest na wczesnym etapie koncepcji, pomagamy dobrać odpowiednie rozwiązania wizualne na podstawie Twoich wytycznych.",
        },
        {
